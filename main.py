...
f = pygame.font.Font("AbstractGroovy-K7Zdy.ttf", 64)
...
right_edit = True
speed = 0
dart = pygame.image.load("dart-removebg-preview.png")
...
while webcam.isOpened():
    ...
    window.blit(dart, dart.get_rect(center=(width / 2, height / 2 + 35)))
    onrelease()
    ...
    i = f.render(f"score: {score}", True, (49, 59, 4), (255, 255, 255))
    d = f.render(f"speed: {ceil(speed)}", True, (49, 59, 4), (255, 255, 255))
    window.blit(i, (0, 0))
    window.blit(d, (0, 700))
